...
integral_contribute_pitch = 0;
integral_contribute_yaw = 0;
integral_contribute_x = 0;
...
angolo_pitch_reference =  pitch_initial;
...
chi_6_prec_vect = zeros(1, frameNumber);
chi_5_prec_vect = zeros(1, frameNumber);
